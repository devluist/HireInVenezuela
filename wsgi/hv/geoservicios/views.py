...
def inicializar_categorias():
	if not Categoria.objects.filter(id=1).exists():
		...
		Categoria.objects.create(nombre=u"Tarjetas de Presentación/Negocio/Invitación", descripcion="", url=u)
		...
		Categoria.objects.create(nombre=u"Python. Frameworks y Librerías", descripcion="", url=u)
		u = UrlCategoria.objects.create(padre=c, url="base-datos")
		Categoria.objects.create(nombre=u"Base de Datos Relacionales y No-Relacionales", descripcion="", url=u)
		u = UrlCategoria.objects.create(padre=c, url="ruby")
		Categoria.objects.create(nombre=u"Ruby. Frameworks y Librerías", descripcion="", url=u)
		...
		Categoria.objects.create(nombre=u"PHP. Frameworks y Librerías", descripcion="", url=u)
		...
		Categoria.objects.create(nombre=u"JavaScript, Node.js, Canvas...", descripcion="", url=u)
		...
		Categoria.objects.create(nombre=u"Pruebas/Testing de Software, Accesibilidad y Usabilidad", descripcion="", url=u)
		...
		Categoria.objects.create(nombre=u"Chistes Escritos sobre Tema/Evento", descripcion="", url=u)
		u = UrlCategoria.objects.create(padre=c, url="humor-grafico-memes")
		Categoria.objects.create(nombre=u"Chistes Gráficos/Memes sobre Tema/Evento", descripcion="", url=u)
