...
def inicializar_categorias():
	if not UrlCategoria.objects.filter(id=1).exists():
		...
		Categoria.objects.create(nombre=u"Ilustraci&oacute;n", descripcion="", url=u, idioma="en")
		...
		Categoria.objects.create(nombre=u"Songwriter", descripcion="", url=u, idioma="en")
		...
		Categoria.objects.create(nombre=u"Custom Songs & Dedication", descripcion="", url=u, idioma="en")
		u = UrlCategoria.objects.get(padre=c, url="otros")
		Categoria.objects.create(nombre=u"Others", descripcion="", url=u, idioma="en")
		...
		Categoria.objects.create(nombre=u"Data Bases", descripcion="", url=u, idioma="en")
		...
		Categoria.objects.create(url=c, nombre=u"Marketing Digital", descripcion="", idioma="en")
		...
		Categoria.objects.create(nombre=u"Market", descripcion="", url=u, idioma="en")
		u = UrlCategoria.objects.get(padre=c, url="presentacion-proyecto-ideas")
		Categoria.objects.create(nombre=u"Proyects/Ideas Presentations", descripcion="", url=u, idioma="en")
		...
		u = UrlCategoria.objects.get(padre=c, url="dietas-nutricionista")
		...
		Categoria.objects.create(nombre=u"Greeting Video", descripcion="", url=u, idioma="en")
		u = UrlCategoria.objects.get(padre=c, url="regalos-divertidos-inesperado")
